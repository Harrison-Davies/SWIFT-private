...
#ifndef SWIFT_REMIX_STRENGTH_IO_DEFAULT_H
#define SWIFT_REMIX_STRENGTH_IO_DEFAULT_H

/**
 * @file REMIX/strength/default/hydro_io_strength.h
...
INLINE static void hydro_write_particles_strength(const struct part* parts,
  ...
  list[*num_fields+1] = io_make_output_field(
...
#endif /* SWIFT_REMIX_STRENGTH_IO_DEFAULT_H */